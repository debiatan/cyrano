...
SRC =  $(ARDUINO)/pins_arduino.c $(ARDUINO)/wiring.c $(ARDUINO)/wiring_analog.c\
...
CXXFLAGS = $(CDEFS) $(CINCS) $(CXXSTANDARD) -O$(OPT)
...
OBJ = $(SRC:.c=.o) $(CXXSRC:.cpp=.o) $(CXXSRC:.cc=.o) $(ASRC:.S=.o) 

# Define all listing files.
LST = $(ASRC:.S=.lst) $(CXXSRC:.cpp=.lst) $(CXXSRC:.cc=.lst) $(SRC:.c=.lst)
...
clean:
	...
	$(INSTALL_DIR)/*.o $(INSTALL_DIR)/*.lst	$(SRC:.c=.s) $(SRC:.c=.d) $(CXXSRC:.cpp=.s) $(CXXSRC:.cpp=.d)
